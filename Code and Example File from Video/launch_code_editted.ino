...
#define OPEN_ANGLE 20 // angle for servo to be when open in deg (used to be 50, my servo can't go that far)
#define CLOSE_ANGLE 100 // angle for servo to be at when closed in deg (used to be 175, my servo can't go that far)
